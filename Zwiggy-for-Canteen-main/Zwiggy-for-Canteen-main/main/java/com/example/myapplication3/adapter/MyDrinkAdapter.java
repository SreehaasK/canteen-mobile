...
import com.example.myapplication3.listener.IRecyclerViewClickListener;
   ...
   FirebaseUser user;
    ...
    private void addToCart(DrinkModel drinkModel) {
        ...
        DatabaseReference userCart= FirebaseDatabase.
                getInstance().getReference("Cart").child(userId);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists())
                {
                    ...
                    userCart.child(drinkModel.getKey()).
                            updateChildren(updateData).addOnSuccessListener(unused -> {
                ...
                else
                {
                    ...
                    userCart.child(drinkModel.getKey()).setValue(cartModel).addOnSuccessListener(unused -> {
                        iCartLoadListener.onCartLoadFailed("Add to Cart Success");
                    }).addOnFailureListener(e -> iCartLoadListener.onCartLoadFailed(e.getMessage()));
                }
